...
\begin{document}
  ...
  \begin{flalign*}
    \vect{x}(t)
    &= e^{\bm{A}t}\vect{x}_0 + \int_{0}^{t} e^{\bm{A}\tau}\bm{B}u(t - \tau)\, d\tau
    &\\
    &= e^{\bm{A}t}\vect{x}_0 + \int_{0}^{t} \prn{\sum_{k = 0}^{n} c_k(\tau) \bm{A}^k}\bm{B}u(t - \tau)\, d\tau
    &\\
    &= e^{\bm{A}t}\vect{x}_0 +
  ...
  \begin{flalign*}
    e^{\bm{A}t}\bm{B}
    &= \sum_{k = 0}^{n - 1} c_k(t) \bm{A}^k\bm{B}
    &\\
    &= \begin{bmatrix} \bm{B} & \bm{A}\bm{B} & \cdots & \bm{A}^{n - 1}\bm{B}\end{bmatrix}
    \begin{bmatrix}
      c_1(t)
    \end{bmatrix}
  \end{flalign*}
